              ...
              <div className="mega-menu-grid">
                ...
                <div className="menu-card">
                  ...
                  <ul className="menu-list">
                    ...
                    <li><Link to="/soluzioni/organizzazione:-agenda-&-prenotazioni/integrazioni" onClick={() => setIsMobileMenuOpen(false)}>Integrazioni</Link></li>
                  </ul>
                </div>
                ...
                <div className="menu-card">
                  ...
                  <ul className="menu-list">
                    ...
                    <li><Link to="/soluzioni/analisi:-fatturazione-e-reportistica/analisi-economiche" onClick={() => setIsMobileMenuOpen(false)}>Analisi Economiche</Link></li>
                  </ul>
                </div>
